...
/***/ function(module, exports, __webpack_require__) {
	...
	var Transactions = _wrapComponent('_component')(_react3.default.createClass({
	  ...
	  removeTransaction: function removeTransaction(id, num) {
	    var _this3 = this;

	    var total = parseFloat(this.state.account.total) - num;
	    fetch('/api/transactions/' + id, {
	      method: 'DELETE'
	    }).then(function () {
	      return fetch('/api/accounts/' + _this3.state.account._id, {
	        method: "PUT",
	        headers: {
	          "Content-Type": "application/json"
	        },
	      ...
	      _this3.setState({ account: data[0] });
	    }).catch(function (err) {
	  ...
	  render: function render() {
	    ...
	    if (this.state.transactions) {
	      trs = this.state.transactions.map(function (val) {
	        return _react3.default.createElement(
	          'tr',
	          { onClick: _this4.editModal.bind(null, val), key: val._id },
	          _react3.default.createElement(
	            'td',
	            null,
	            '$',
